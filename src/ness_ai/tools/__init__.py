...
from ness_ai.tools.ask import question
from ness_ai.tools.discover import add_tools, search_tools
from ness_ai.tools.fs import delete, edit, glob, is_git_repo, read, write
from ness_ai.tools.search import grep
from ness_ai.tools.shell import shell as shell_tool
from ness_ai.tools.skill import skill_view
from ness_ai.tools.subagents import spawn_subagent
from ness_ai.tools.todo import todo
from ness_ai.tools.web import fetch_url, web_search
...
class ToolRegistry:
    ...
    One registry is shared across all sessions on a :class:`~ness_ai.agent.NessAgent`
