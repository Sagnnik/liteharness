...
from ness_ai.context.overlay import OverlayContext, OverlayProvider
from ness_ai.graph.state import AgentState
from ness_ai.instructions import PLAN_MODE, ACT_MODE
...
class CodingOverlay(OverlayProvider):
    ...
    def sections(self, state: AgentState, ctx: OverlayContext) -> dict[str, str]:
        ...
        ``mode_switch``
            ...
            :data:`~ness_ai.instructions.ACT_MODE`).
