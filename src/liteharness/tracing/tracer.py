...
# --- parent span context ------------------------------------------------
# Liteharness spans are linked into a tree through this ContextVar. Every
...
_current_span: "contextvars.ContextVar[Span | None]" = contextvars.ContextVar(
    "liteharness_current_span", default=None
)
...
class Tracer(Protocol):
    ...
    :mod:`liteharness.tracing.semconv` (or ``None`` → internal).
    """
