...
from ness_cli.tui.theme import RICH_THEME
from ness_cli.tui.formatting import _format_duration
...
def _reasoning_block_lines(text: str, *, elapsed: float, expanded: bool, width: int) -> list[TranscriptLine]:
    # Duration label uses the shared formatter from ness_cli.tui.formatting so any
