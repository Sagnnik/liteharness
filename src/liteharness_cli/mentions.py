...
:mod:`liteharness_cli.coding_session` adapter can expand ``@file`` mentions
...
(validated through :class:`liteharness.permissions.PermissionStore`) and
...
in :mod:`liteharness_cli.events`'s :func:`events_to_messages`).
