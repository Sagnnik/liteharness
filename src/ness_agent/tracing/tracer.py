...
# --- parent span context ------------------------------------------------
# Ness Agent spans are linked into a tree through this ContextVar. Every
...
_current_span: "contextvars.ContextVar[Span | None]" = contextvars.ContextVar(
    "ness_agent_current_span", default=None
)
...
class Tracer(Protocol):
    ...
    :mod:`ness_agent.tracing.semconv` (or ``None`` → internal).
    """
