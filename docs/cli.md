...
**Ness** is the interactive coding-agent CLI shipped with LiteHarness. It uses OpenRouter-compatible chat models, plan/act modes, filesystem-driven extension points under `.ness/`, and a full TUI for approvals, thread history, and configuration.
